---
title: "Using MEMA to Annotate Cell-Level Data"
author: "Mark Dane"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using MEMA to Annotate Cell-Level Data}
...
```{r Read and clean spotmetadata, echo=TRUE}
...
```{r ScanR merge_normalize and QA, echo=TRUE}
...
```{r, echo=TRUE, message=FALSE, warnings=FALSE, eval=TRUE}
